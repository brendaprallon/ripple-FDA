...
# Description of scripts used in the final project with input and output files

### Data in database that Sergio collected
## Input files
# data/raw/bitcoin_address_inputs_outputs_v2_indexed.sqlite3
## Output files
...
## Input files
# data/raw/wallets_from_blockchain.rds
# data/new labels/new_labels.csv # dictionary with new labels
## Output files
...
# data/treated/sample_addr_list_10obs.rds # list with 12 sample addresses per category, to use for plotting, min 10 obs
# data/treated/sample_addr_list_20obs.rds # list with 12 sample addresses per category, to use for plotting, min 20 obs
...
### Plots for the original functions (values)
## Input files
# data/treated/cred_debt_complete.rds # all treated data
# data/treated/sample_addr_list_10obs.rds # list with 12 sample addresses per category, to use for plotting, min 10 obs
# data/treated/sample_addr_list_20obs.rds # list with 12 sample addresses per category, to use for plotting, min 20 obs
...
# graphics/curves/original/fixed scale/original_curves_exchange_10obs.png
# graphics/curves/original/fixed scale/original_curves_exchange_20obs.png
...
# graphics/curves/original/fixed scale/original_curves_mining_10obs.png
# graphics/curves/original/fixed scale/original_curves_mining_20obs.png
# graphics/curves/original/fixed scale/original_curves_mixer_service_10obs.png
# graphics/curves/original/fixed scale/original_curves_mixer_service_20obs.png
# graphics/curves/original/fixed scale/original_curves_payment_system_10obs.png
# graphics/curves/original/fixed scale/original_curves_payment_system_20obs.png
...
# graphics/curves/original/free scale/original_curves_exchange_10obs.png
# graphics/curves/original/free scale/original_curves_exchange_20obs.png
...
# graphics/curves/original/free scale/original_curves_mining_10obs.png
# graphics/curves/original/free scale/original_curves_mining_20obs.png
# graphics/curves/original/free scale/original_curves_mixer_service_10obs.png
# graphics/curves/original/free scale/original_curves_mixer_service_20obs.png
# graphics/curves/original/free scale/original_curves_payment_system_10obs.png
# graphics/curves/original/free scale/original_curves_payment_system_20obs.png
...
### Plots for the step functions, credits and debts
## Input files
# data/treated/sample_addr_list_10obs.rds # list with 12 sample addresses per category, to use for plotting, min 10 obs
# data/treated/sample_addr_list_20obs.rds # list with 12 sample addresses per category, to use for plotting, min 20 obs
# data/treated/cred_debt_balanced_10obs.rds # balanced sample of treated data, min 10 obs. Obs.: the balanced sample could be selected later, but since there is heavy computation in the following codes, we select it now to run the next scripts only with them.
...
# graphics/curves/step/fixed scale/step_curves_exchange_10obs.png
# graphics/curves/step/fixed scale/step_curves_exchange_20obs.png
...
# graphics/curves/step/fixed scale/step_curves_mining_10obs.png
# graphics/curves/step/fixed scale/step_curves_mining_20obs.png
# graphics/curves/step/fixed scale/step_curves_mixer_service_10obs.png
# graphics/curves/step/fixed scale/step_curves_mixer_service_20obs.png
# graphics/curves/step/fixed scale/step_curves_payment_system_10obs.png
# graphics/curves/step/fixed scale/step_curves_payment_system_20obs.png
# (y scale varys between plots)
...
# graphics/curves/step/free scale/step_curves_exchange_10obs.png
# graphics/curves/step/free scale/step_curves_exchange_20obs.png
...
# graphics/curves/step/free scale/step_curves_mining_10obs.png
# graphics/curves/step/free scale/step_curves_mining_20obs.png
# graphics/curves/step/free scale/step_curves_mixer_service_10obs.png
# graphics/curves/step/free scale/step_curves_mixer_service_20obs.png
# graphics/curves/step/free scale/step_curves_payment_system_10obs.png
# graphics/curves/step/free scale/step_curves_payment_system_20obs.png
...
### Plots for the smooth functions, credits and debts
## Input files
# data/treated/sample_addr_list_10obs.rds # list with 12 sample addresses per category, to use for plotting, min 10 obs
# data/treated/sample_addr_list_20obs.rds # list with 12 sample addresses per category, to use for plotting, min 20 obs
# data/treated/wallets_presmooth_balanced_10obs.rds # balanced sample with step functions, min 10 obs
...
# graphics/curves/smooth/fixed scale/smooth_curves_exchange_10obs_credit.png
# graphics/curves/smooth/fixed scale/smooth_curves_exchange_20obs_credit.png
...
# graphics/curves/smooth/fixed scale/smooth_curves_mining_10obs_credit.png
# graphics/curves/smooth/fixed scale/smooth_curves_mining_20obs_credit.png
# graphics/curves/smooth/fixed scale/smooth_curves_mixert_service_10obs_credit.png
# graphics/curves/smooth/fixed scale/smooth_curves_mixer_service_20obs_credit.png
# graphics/curves/smooth/fixed scale/smooth_curves_payment_system_10obs_credit.png
# graphics/curves/smooth/fixed scale/smooth_curves_payment_system_20obs_credit.png
# Debt
...
# graphics/curves/smooth/fixed scale/smooth_curves_exchange_10obs_debt.png
# graphics/curves/smooth/fixed scale/smooth_curves_exchange_20obs_debt.png
...
# graphics/curves/smooth/fixed scale/smooth_curves_mining_10obs_debt.png
# graphics/curves/smooth/fixed scale/smooth_curves_mining_20obs_debt.png
# graphics/curves/smooth/fixed scale/smooth_curves_mixer_service_10obs_debt.png
# graphics/curves/smooth/fixed scale/smooth_curves_mixer_service_20obs_debt.png
# graphics/curves/smooth/fixed scale/smooth_curves_payment_system_10obs_debt.png
# graphics/curves/smooth/fixed scale/smooth_curves_payment_system_20obs_debt.png
# (y scale varys between plots)
# Credit
...
# graphics/curves/smooth/free scale/smooth_curves_exchange_10obs_credit.png
# graphics/curves/smooth/free scale/smooth_curves_exchange_20obs_credit.png
...
# graphics/curves/smooth/free scale/smooth_curves_mining_10obs_credit.png
# graphics/curves/smooth/free scale/smooth_curves_mining_20obs_credit.png
# graphics/curves/smooth/free scale/smooth_curves_mixer_service_10obs_credit.png
# graphics/curves/smooth/free scale/smooth_curves_mixer_service_20obs_credit.png
# graphics/curves/smooth/free scale/smooth_curves_payment_system_10obs_credit.png
# graphics/curves/smooth/free scale/smooth_curves_payment_system_20obs_credit.png
# Debt
...
# graphics/curves/smooth/free scale/smooth_curves_exchange_10obs_debt.png
# graphics/curves/smooth/free scale/smooth_curves_exchange_20obs_debt.png
...
# graphics/curves/smooth/free scale/smooth_curves_mining_10obs_debt.png
# graphics/curves/smooth/free scale/smooth_curves_mining_20obs_debt.png
# graphics/curves/smooth/free scale/smooth_curves_mixer_service_10obs_debt.png
# graphics/curves/smooth/free scale/smooth_curves_mixer_service_20obs_debt.png
# graphics/curves/smooth/free scale/smooth_curves_payment_system_10obs_debt.png
# graphics/curves/smooth/free scale/smooth_curves_payment_system_20obs_debt.png
source("R/plot_smooth_curves.R")

### Plots for the smooth derivatives, credits and debts
## Input files
# data/treated/sample_addr_list_10obs.rds # list with 12 sample addresses per category, to use for plotting, min 10 obs
# data/treated/sample_addr_list_20obs.rds # list with 12 sample addresses per category, to use for plotting, min 20 obs
...
# graphics/derivatives/fixed scale/smooth_derivatives_exchange_10obs_credit.png
# graphics/derivatives/fixed scale/smooth_derivatives_exchange_20obs_credit.png
...
# graphics/derivatives/fixed scale/smooth_derivatives_mining_10obs_credit.png
# graphics/derivatives/fixed scale/smooth_derivatives_mining_20obs_credit.png
# graphics/derivatives/fixed scale/smooth_derivatives_mixer_service_10obs_credit.png
# graphics/derivatives/fixed scale/smooth_derivatives_mixer_service_20obs_credit.png
# graphics/derivatives/fixed scale/smooth_derivatives_payment_system_10obs_credit.png
# graphics/derivatives/fixed scale/smooth_derivatives_payment_system_20obs_credit.png
# Debt
...
# graphics/derivatives/fixed scale/smooth_derivatives_exchange_10obs_debt.png
# graphics/derivatives/fixed scale/smooth_derivatives_exchange_20obs_debt.png
...
# graphics/derivatives/fixed scale/smooth_derivatives_mining_10obs_debt.png
# graphics/derivatives/fixed scale/smooth_derivatives_mining_20obs_debt.png
# graphics/derivatives/fixed scale/smooth_derivatives_mixer_service_10obs_debt.png
# graphics/derivatives/fixed scale/smooth_derivatives_mixer_service_20obs_debt.png
# graphics/derivatives/fixed scale/smooth_derivatives_payment_system_10obs_debt.png
# graphics/derivatives/fixed scale/smooth_derivatives_payment_system_20obs_debt.png
# (y scale varys between plots)
# Credit
...
# graphics/derivatives/free scale/smooth_derivatives_exchange_10obs_credit.png
# graphics/derivatives/free scale/smooth_derivatives_exchange_20obs_credit.png
...
# graphics/derivatives/free scale/smooth_derivatives_mining_10obs_credit.png
# graphics/derivatives/free scale/smooth_derivatives_mining_20obs_credit.png
# graphics/derivatives/free scale/smooth_derivatives_mixer_service_10obs_credit.png
# graphics/derivatives/free scale/smooth_derivatives_mixer_service_20obs_credit.png
# graphics/derivatives/free scale/smooth_derivatives_payment_system_10obs_credit.png
# graphics/derivatives/free scale/smooth_derivatives_payment_system_20obs_credit.png
# Debt
...
# graphics/derivatives/free scale/smooth_derivatives_exchange_10obs_debt.png
# graphics/derivatives/free scale/smooth_derivatives_exchange_20obs_debt.png
...
# graphics/derivatives/free scale/smooth_derivatives_mining_10obs_debt.png
# graphics/derivatives/free scale/smooth_derivatives_mining_20obs_debt.png
# graphics/derivatives/free scale/smooth_derivatives_mixer_service_10obs_debt.png
# graphics/derivatives/free scale/smooth_derivatives_mixer_service_20obs_debt.png
# graphics/derivatives/free scale/smooth_derivatives_payment_system_10obs_debt.png
# graphics/derivatives/free scale/smooth_derivatives_payment_system_20obs_debt.png
source("R/plot_smooth_derivatives.R")

### Calculating poisson rates 
# For this code and the next, we used packages “future” and “future.apply” to use parallelization. After installing the packages, the script below should be run via command line.
## Input files
# data/treated/cred_debt_balanced_10obs.rds # balanced sample of treated data, min 10 obs
# data/treated/cred_debt_balanced_20obs.rds # balanced sample of treated data, min 20 obs
## Output files
...
# graphics/poisson rates/fixed scale/poisson_rates_exchange_10obs_credit.png
# graphics/poisson rates/fixed scale/poisson_rates_exchange_20obs_credit.png
...
# graphics/poisson rates/fixed scale/poisson_rates_mining_10obs_credit.png
# graphics/poisson rates/fixed scale/poisson_rates_mining_20obs_credit.png
# graphics/poisson rates/fixed scale/poisson_rates_mixer_service_10obs_credit.png
# graphics/poisson rates/fixed scale/poisson_rates_mixer_service_20obs_credit.png
# graphics/poisson rates/fixed scale/poisson_rates_payment_system_10obs_credit.png
# graphics/poisson rates/fixed scale/poisson_rates_payment_system_20obs_credit.png
# Debt
...
# graphics/poisson rates/fixed scale/poisson_rates_exchange_10obs_debt.png
# graphics/poisson rates/fixed scale/poisson_rates_exchange_20obs_debt.png
...
# graphics/poisson rates/fixed scale/poisson_rates_mining_10obs_debt.png
# graphics/poisson rates/fixed scale/poisson_rates_mining_20obs_debt.png
# graphics/poisson rates/fixed scale/poisson_rates_mixer_service_10obs_debt.png
# graphics/poisson rates/fixed scale/poisson_rates_mixer_service_20obs_debt.png
# graphics/poisson rates/fixed scale/poisson_rates_payment_system_10obs_debt.png
# graphics/poisson rates/fixed scale/poisson_rates_payment_system_20obs_debt.png
# (y scale varys between plots)
# Credit
...
# graphics/poisson rates/free scale/poisson_rates_exchange_10obs_credit.png
# graphics/poisson rates/free scale/poisson_rates_exchange_20obs_credit.png
...
# graphics/poisson rates/free scale/poisson_rates_mining_10obs_credit.png
# graphics/poisson rates/free scale/poisson_rates_mining_20obs_credit.png
# graphics/poisson rates/free scale/poisson_rates_mixer_service_10obs_credit.png
# graphics/poisson rates/free scale/poisson_rates_mixer_service_20obs_credit.png
# graphics/poisson rates/free scale/poisson_rates_payment_system_10obs_credit.png
# graphics/poisson rates/free scale/poisson_rates_payment_system_20obs_credit.png
# Debt
...
# graphics/poisson rates/free scale/poisson_rates_exchange_10obs_debt.png
# graphics/poisson rates/free scale/poisson_rates_exchange_20obs_debt.png
...
# graphics/poisson rates/free scale/poisson_rates_mining_10obs_debt.png
# graphics/poisson rates/free scale/poisson_rates_mining_20obs_debt.png
# graphics/poisson rates/free scale/poisson_rates_mixer_service_10obs_debt.png
# graphics/poisson rates/free scale/poisson_rates_mixer_debt_service_20obs_debt.png
# graphics/poisson rates/free scale/poisson_rates_payment_debt_system_10obs_debt.png
# graphics/poisson rates/free scale/poisson_rates_payment_debt_system_20obs_debt.png
...
### Models
## Input files
# R/parametric models (which uses R/fpca_model_frame.R)
# data/treated/scalar/scalar_features_10obs.rds
# data/treated/rates/poisson_rates_10obs.rds
...
### Table of cross validated results
## Input files
# All in folder models/multiclass/min_obs_10/
# All in folder models/multiclass/min_obs_20/
## Output files:
...
### Evaluating winner model with test set
## Input files
# data/treated/scalar/scalar_features_10obs.rds
...
## Input files
## Input files
# R/clean/parametric_models.R (which uses R/clean/fpca_model_frame.R)
# data/treated/scalar/scalar_features_10obs.rds
# data/treated/rates/poisson_rates_10obs.rds
# data/treated/wallets_log_smoothed_balanced_10obs.rds
# results/min_10obs.rds
